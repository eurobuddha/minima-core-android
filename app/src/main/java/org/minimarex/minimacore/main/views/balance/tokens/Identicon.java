...
/**
 * Deterministic token identicon — ported from the utxoWallet/Minima wallet: a 5×5 grid
 * mirrored on the vertical axis, cells + hue derived from the tokenid's hex. Same tokenid →
 * same picture, computed locally (leaks nothing). Plus the web-validation check badge.
 */
public final class Identicon {
    ...
    public static Bitmap forToken(String tokenid, int px) {
        ...
        float scale = px / 48f;      // viewBox 48, cells 8px, outer pad 4px
